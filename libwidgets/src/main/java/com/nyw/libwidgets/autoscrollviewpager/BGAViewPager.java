...
public class BGAViewPager extends ViewPager {
    ...
    public void setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        ...
        try {
            ...
            Method setChildrenDrawingOrderEnabledCompatMethod = viewpagerClass.getDeclaredMethod(
    ...
    public void setBannerCurrentItemInternal(int position, boolean smoothScroll) {
        Class viewpagerClass = ViewPager.class;
        try {
            Method setCurrentItemInternalMethod = viewpagerClass.getDeclaredMethod(
                    "setCurrentItemInternal", int.class, boolean.class, boolean.class);
