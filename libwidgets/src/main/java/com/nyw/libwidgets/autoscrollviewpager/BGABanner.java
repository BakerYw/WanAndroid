package com.nyw.libwidgets.autoscrollviewpager;
...
import com.nyw.libwidgets.autoscrollviewpager.transformer.BGAPageTransformer;
import com.nyw.libwidgets.autoscrollviewpager.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager
    ...
    private BGAOnNoDoubleClickListener mGuideOnNoDoubleClickListener = new
            BGAOnNoDoubleClickListener() {
                @Override
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.BGABanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable
                    .bga_banner_selector_point_solid);
            ...
            mPointContainerLeftRightPadding = typedArray.getDimensionPixelSize(attr,
            ...
            mNumberIndicatorTextSize = typedArray.getDimensionPixelSize(attr,
                    mNumberIndicatorTextSize);
            ...
            mIsNeedShowIndicatorOnOnlyOnePage = typedArray.getBoolean(attr,
    ...
    private void initView(Context context) {
        ...
        pointContainerRl.setPadding(mPointContainerLeftRightPadding, mPointTopBottomMargin,
                mPointContainerLeftRightPadding, mPointTopBottomMargin);
    ...
    public void showPlaceholder() {
        if (mPlaceholderIv == null && mPlaceholderDrawableResId != NO_PLACEHOLDER_DRAWABLE) {
            mPlaceholderIv = BGABannerUtil.getItemImageView(getContext(),
     ...
     * @param tips        每一页的提示文案集合
     */
    public void setData(@LayoutRes int layoutResId, List<? extends Object> models, List<String>
            tips) {
     ...
     */
    public void setEnterSkipViewIdAndDelegate(int enterResId, int skipResId, GuideDelegate
            guideDelegate) {
    ...
    private void initIndicator() {
        if (mPointRealContainerLl != null) {
            ...
            if (mIsNeedShowIndicatorOnOnlyOnePage || (!mIsNeedShowIndicatorOnOnlyOnePage &&
                    mViews.size() > 1)) {
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LWC, LWC);
                lp.setMargins(mPointLeftRightMargin, mPointTopBottomMargin,
                        mPointLeftRightMargin, mPointTopBottomMargin);
                ImageView imageView;
    ...
    private void initViewPager() {
        ...
        mViewPager.setOverScrollMode(mOverScrollMode);
        mViewPager.setAllowUserScrollable(mAllowUserScrollable);
        mViewPager.setPageTransformer(true, BGAPageTransformer.getPageTransformer
                (mTransitionEffect));
    ...
    private void switchToPoint(int newCurrentPoint) {
        ...
        if (mPointRealContainerLl != null) {
            if (mViews != null && mViews.size() > 0 && newCurrentPoint < mViews.size() && (
                    (mIsNeedShowIndicatorOnOnlyOnePage || (!mIsNeedShowIndicatorOnOnlyOnePage &&
                            mViews.size() > 1)))) {
    ...
    public void handleAutoPlayActionUpOrCancel(float xVelocity) {
        if (mViewPager != null) {
            if (mPageScrollPosition < mViewPager.getCurrentItem()) {
                // 往右滑
                if (xVelocity > VEL_THRESHOLD || (mPageScrollPositionOffset < 0.7f && xVelocity >
                        -VEL_THRESHOLD)) {
                ...
                // 往左滑
                if (xVelocity < -VEL_THRESHOLD || (mPageScrollPositionOffset > 0.3f && xVelocity
                        < VEL_THRESHOLD)) {
                    mViewPager.setBannerCurrentItemInternal(mPageScrollPosition + 1, true);
                } else {
                    mViewPager.setBannerCurrentItemInternal(mPageScrollPosition, true);
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (mOnPageChangeListener != null) {
            mOnPageChangeListener.onPageScrolled(position % mViews.size(), positionOffset,
                    positionOffsetPixels);
        }
    }
            ...
            if (mDelegate != null) {
                view.setOnClickListener(new BGAOnNoDoubleClickListener() {
                    ...
                    public void onNoDoubleClick(View view) {
                        ...
                        mDelegate.onBannerItemClick(BGABanner.this, view, mModels == null ? null
                                : mModels.get(currentPosition), currentPosition);
                    }
                });
            }

            if (mAdapter != null) {
                mAdapter.fillBannerItem(BGABanner.this, view, mModels == null ? null : mModels
                        .get(finalPosition), finalPosition);
            }
