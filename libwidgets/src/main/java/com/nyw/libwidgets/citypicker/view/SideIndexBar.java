package com.nyw.libwidgets.citypicker.view;
...
public class SideIndexBar extends View {
    private static final String[] DEFAULT_INDEX_ITEMS = {"定位", "历史", "热门", "A", "B", "C", "D", "E",
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mOnIndexChangedListener != null && touchedIndex >= 0 && touchedIndex < indexSize) {
                    if (touchedIndex != mCurrentIndex) {
                        ...
                        mOnIndexChangedListener.onIndexChanged(mIndexItems.get(touchedIndex),
                                touchedIndex);
                        invalidate();
                    }
                }
